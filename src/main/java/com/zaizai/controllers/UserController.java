...
public class UserController {
	...
	public List<UserEditResponseModel> getUsers(@RequestParam(value="page", defaultValue="0") int page, @RequestParam(value="limit", defaultValue="20") int limit) {
	...
	public OperationStatusModel deleteUser(@PathVariable String id) {
		...
		OperationStatusModel returnModel = new OperationStatusModel(OperationName.DELETE.name(), RequestOperationStatus.SUCCESS.name());
		return returnModel;
	}
}
